...
$(document).ready(function () {
	...
	*/
	function loadImage() {
		...
		var imageName = "img/ink_" + (loadedImages + 1) + ".jpg";
		/*
	...
	* and calls the "showink" method, that displays the image slider.
	*/
	function imageLoaded() {
		...
		if (loadedImages == totalFrames) {
			...
			/*
				...
				When the preloader is completely faded, it stops the preloader rendering and calls the "showink" function to display the images.
			*/
