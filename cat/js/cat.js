...
$(document).ready(function () {
	...
	*/
	function loadImage() {
		...
		var imageName = "img/cat_" + (loadedImages + 1) + ".jpg";
		/*
	...
	* and calls the "showcat" method, that displays the image slider.
	*/
	function imageLoaded() {
		...
		if (loadedImages == totalFrames) {
			...
			/*
				...
				When the preloader is completely faded, it stops the preloader rendering and calls the "showcat" function to display the images.
			*/
