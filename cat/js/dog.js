...
$(document).ready(function () {
	...
	*/
	function loadImage() {
		...
		var imageName = "img/dog_" + (loadedImages + 1) + ".jpg";
		/*
	...
	* and calls the "showDog" method, that displays the image slider.
	*/
	function imageLoaded() {
		...
		if (loadedImages == totalFrames) {
			...
			/*
				...
				When the preloader is completely faded, it stops the preloader rendering and calls the "showDog" function to display the images.
			*/
